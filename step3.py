...
# with command line options: step3 --filein file:step2.root --fileout file:step3.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 76X_mcRun2_asymptotic_v12 --step PAT --python_filename step3.py --era Run2_25ns --no_exec -n 50000
