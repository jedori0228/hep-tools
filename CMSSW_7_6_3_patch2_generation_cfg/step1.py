...
# with command line options: Hadronizer_TuneCUETP8M1_13TeV_generic_LHE_pythia8_cff.py --filein file:cmsgrid_final.lhe --mc --pileup_input dbs:/MinBias_TuneCUETP8M1_13TeV-pythia8/RunIIWinter15GS-MCRUN2_71_V1-v1/GEN-SIM --eventcontent RAWSIM --pileup 2015_25ns_FallMC_matchData_PoissonOOTPU --datatier GEN-SIM-RAW --era Run2_25ns --conditions 76X_mcRun2_asymptotic_v12 --magField 38T_PostLS1 --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:@frozen25ns --no_exec -n 50000 --python_filename step1.py --fileout file:step1.root
...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:/cms/scratch/jskim/lhefiles/13TeV_HN40_mumumu_width_AUTO_VmuN_0p1/unweighted_events_0.lhe'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Hadronizer_TuneCUETP8M1_13TeV_generic_LHE_pythia8_cff.py nevts:50000'),
